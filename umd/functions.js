(function (factory) {
	...
	exports.AVERAGEIF = function(range, criteria, average_range) {
	  ...
	  average_range = common.parseNumberArray(common.flatten(average_range));
	...
	exports.COUNT = function() {
	  return common.numbers(common.flatten(arguments)).length;
	};
	...
	exports.MAXA = function() {
	  var range = common.arrayValuesToNumbers(common.flatten(arguments));
	  return (range.length === 0) ? 0 : Math.max.apply(Math, range);
	};
	...
	exports.ATAN2 = function(number_x, number_y) {
	  ...
	  if (common.anyIsError(number_x, number_y)) {
	    return error.value;
	  }
	...
	exports.BASE = function(number, radix, min_length) {
	  ...
	  if (common.anyIsError(number, radix, min_length)) {
	    return error.value;
	  }
	...
	exports.CEILING = function(number, significance, mode) {
	  ...
	  if (common.anyIsError(number, significance, mode)) {
	    return error.value;
	  }
	  if (significance === 0) {
	    return 0;
	...
	exports.FLOOR = function(number, significance) {
	  number = common.parseNumber(number);
	  significance = common.parseNumber(significance);
	  if (common.anyIsError(number, significance)) {
	    return error.value;
	  }
	  if (significance === 0) {
	    return 0;
	...
	exports.LOG = function(number, base) {
	  number = common.parseNumber(number);
	  base = base ? common.parseNumber(base) : 10;
	  if (common.anyIsError(number, base)) {
	    return error.value;
	  }
	...
	exports.MOD = function(dividend, divisor) {
	  ...
	  if (common.anyIsError(dividend, divisor)) {
	    return error.value;
	  }
	  if (divisor === 0) {
	    return error.div0;
	...
	exports.MROUND = function(number, multiple) {
	  ...
	  if (common.anyIsError(number, multiple)) {
	    return error.value;
	  }
	...
	exports.POWER = function(number, power) {
	  ...
	  if (common.anyIsError(number, power)) {
	    return error.value;
	  }
	...
	exports.QUOTIENT = function(numerator, denominator) {
	  ...
	  if (common.anyIsError(numerator, denominator)) {
	    return error.value;
	  }
	...
	exports.RANDBETWEEN = function(bottom, top) {
	  ...
	  if (common.anyIsError(bottom, top)) {
	    return error.value;
	  }
	...
	exports.ROUND = function(number, digits) {
	  ...
	  if (common.anyIsError(number, digits)) {
	    return error.value;
	  }
	...
	exports.ADD = function (num1, num2) {
	  ...
	  if (common.anyIsError(num1, num2)) {
	    return error.value;
	  }
	...
	exports.MULTIPLY = function (factor1, factor2) {
	  ...
	  if (common.anyIsError(factor1, factor2)) {
	    return error.value;
	  }
	...
	exports.POW = function (base, exponent) {
	  ...
	  exponent = common.parseNumber(exponent);
	  if (common.anyIsError(base, exponent)) {
	    return error.error;
	  }
	...
	exports.SUMPRODUCT = function() {
	  ...
	  for (var i = 0; i < arguments[0].length; i++) {
	    if (!(arguments[0][i] instanceof Array)) {
	      product = 1;
	      for (k = 1; k < arrays; k++) {
	        _i = common.parseNumber(arguments[k - 1][i]);
	      ...
	      for (var j = 0; j < arguments[0][i].length; j++) {
	        product = 1;
	        for (k = 1; k < arrays; k++) {
	          _ij = common.parseNumber(arguments[k - 1][i][j]);
	...
	exports.DAYS360 = function (start_date, end_date, method) {
	  method = common.parseBool(method);
	  start_date = common.parseDate(start_date);
	  end_date = common.parseDate(end_date);
	...
	var MATCH = function(lookupValue, lookupArray, matchType) {
	...
	var VLOOKUP = function (needle, table, index, rangeLookup) {
	...
	var HLOOKUP = function (needle, table, index, rangeLookup) {
	  if (!needle || !table || !index) {
	    return error.na;
	  }
	  ...
	  var transposedTable = common.transpose(table);
	...
	var LOOKUP = function (searchCriterion, array, resultArray) {
	...
	var INDEX = function (cellRange, rowNumber, columnNumber) {
